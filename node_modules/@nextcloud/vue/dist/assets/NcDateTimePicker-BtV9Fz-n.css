...
.mx-datepicker[data-v-a8e1a64] {
  user-select: none;
  color: var(--color-main-text);
  /* INPUT CONTAINER */
}
.mx-datepicker[data-v-a8e1a64] svg {
  fill: var(--color-main-text);
}
.mx-datepicker[data-v-a8e1a64] .mx-input-wrapper .mx-input {
  width: 100%;
  border: 2px solid var(--color-border-maxcontrast);
  background-color: var(--color-main-background);
  background-clip: content-box;
}
.mx-datepicker[data-v-a8e1a64] .mx-input-wrapper .mx-input:active:not(.disabled), .mx-datepicker[data-v-a8e1a64] .mx-input-wrapper .mx-input:hover:not(.disabled), .mx-datepicker[data-v-a8e1a64] .mx-input-wrapper .mx-input:focus:not(.disabled) {
  border-color: var(--color-primary-element);
}
.mx-datepicker[data-v-a8e1a64] .mx-input-wrapper:disabled, .mx-datepicker[data-v-a8e1a64] .mx-input-wrapper.disabled {
  cursor: not-allowed;
  opacity: 0.7;
}
.mx-datepicker[data-v-a8e1a64] .mx-input-wrapper .mx-icon-calendar,
.mx-datepicker[data-v-a8e1a64] .mx-input-wrapper .mx-icon-clear {
