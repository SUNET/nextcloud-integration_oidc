require('../assets/NcInputConfirmCancel-EYtW7MxF.css');
"use strict";
...
const _sfc_main = {
  ...
  data() {
    return {
      labelConfirm: _l10n.t("Confirm changes"),
      labelCancel: _l10n.t("Cancel changes")
    };
  },
  computed: {
    valueModel: {
...
exports.NcInputConfirmCancel = NcInputConfirmCancel;
