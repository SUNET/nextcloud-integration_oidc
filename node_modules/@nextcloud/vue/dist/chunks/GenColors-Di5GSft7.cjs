...
const defaultPalette = [
  new Color(182, 70, 157, _l10n.t("Purple")),
  new Color(
    191,
    103,
    139,
...
function GenColors(steps) {
  const red = new Color(182, 70, 157, _l10n.t("Purple"));
  const yellow = new Color(221, 203, 85, _l10n.t("Gold"));
  const blue = new Color(0, 130, 201, _l10n.t("Nextcloud blue"));
