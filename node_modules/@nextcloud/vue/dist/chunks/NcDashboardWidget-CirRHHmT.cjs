...
const NcDashboardWidgetItem = require("./NcDashboardWidgetItem-COONyn0g.cjs");
...
const _sfc_main = {
  ...
  components: {
    ...
    NcDashboardWidgetItem: NcDashboardWidgetItem.NcDashboardWidgetItem,
