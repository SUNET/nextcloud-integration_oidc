require('../assets/NcSelect-GdIw6cIy.css');
"use strict";
...
const NcListItemIcon = require("./NcListItemIcon-pOj8Vr2H.cjs");
...
const _sfc_main = {
  ...
  props: {
    ...
    ...vueSelect.VueSelect.props,
    ...vueSelect.VueSelect.mixins.reduce((allProps, mixin) => ({ ...allProps, ...mixin.props }), {}),
    /**
    ...
    components: {
      ...
      default: () => ({
        Deselect: {
          render: (createElement) => createElement(Close.Close, {
            props: {
              size: 20,
    ...
    inputId: {
      type: String,
      default: () => `select-input-${GenRandomId.GenRandomId()}`
    },
    /**
  ...
  computed: {
    ...
    localCalculatePosition() {
      ...
      return (dropdownMenu, component, { width }) => {
        ...
        const updatePosition = () => {
          dom.computePosition(component.$refs.toggle, dropdownMenu, {
            ...
            middleware: [
              ...
              dom.flip(),
              dom.shift({ limiter: dom.limitShift() })
            ]
          }).then(({ x, y }) => {
    ...
    localFilterBy() {
      ...
      return vueSelect.VueSelect.props.filterBy.default;
    },
    localLabel() {
      if (this.label !== null) {
        return this.label;
      ...
      return vueSelect.VueSelect.props.label.default;
    },
    propsToForward() {
      const vueSelectKeys = [
        ...Object.keys(vueSelect.VueSelect.props),
        ...vueSelect.VueSelect.mixins.flatMap((mixin) => Object.keys(mixin.props ?? {}))
      ];
  ...
  mounted() {
    if (!this.labelOutside && !this.inputLabel && !this.ariaLabelCombobox) {
      Vue__default.default.util.warn("[NcSelect] An `inputLabel` or `ariaLabelCombobox` should be set. If an external label is used, `labelOutside` should be set to `true`.");
    }
    if (this.inputLabel && this.ariaLabelCombobox) {
      Vue__default.default.util.warn("[NcSelect] Only one of `inputLabel` or `ariaLabelCombobox` should to be set.");
    }
  },
  methods: {
    t: _l10n.t
