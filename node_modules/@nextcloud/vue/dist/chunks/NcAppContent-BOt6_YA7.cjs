require('../assets/NcAppContent-BO0ksFwD.css');
"use strict";
...
const _sfc_main$1 = {
  ...
  computed: {
    title() {
      return _l10n.t("Go back to the list");
    }
  },
  watch: {
    isMobile: {
  ...
  methods: {
    toggleAppNavigationButton(hide = true) {
      ...
      if (appNavigationToggle) {
        ...
        if (hide === true) {
          eventBus.emit("toggle-navigation", { open: false });
        }
      }
    }
  }
...
const _sfc_main = {
  ...
  components: {
    NcAppDetailsToggle,
    Pane: splitpanes.Pane,
    Splitpanes: splitpanes.Splitpanes
  },
  props: {
    /**
  ...
  mounted() {
    if (this.allowSwipeNavigation && !this.disableSwipe) {
      this.swiping = core.useSwipe(this.$el, {
...
exports.NcAppContent = NcAppContent;
