...
const gettext$1 = require("@nextcloud/l10n/gettext");
const builder = gettext$1.getGettextBuilder().setLanguage(l10n.getLanguage());
  ...
  for (const chunk of chunks) {
    if (!chunk.registered) {
      for (const { l: language, t: translations } of chunk) {
        if (language !== l10n.getLanguage() || !translations) {
          continue;
        }
        ...
        gettext = builder.addTranslation(l10n.getLanguage(), {
          translations: {
            "": {
