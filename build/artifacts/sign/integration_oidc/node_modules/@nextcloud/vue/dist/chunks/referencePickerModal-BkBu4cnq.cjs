require('../assets/referencePickerModal-CTumspFH.css');
"use strict";
const Functions_registerReference = require("./index-BV85rPB7.cjs");
...
const _sfc_main$8 = {
  ...
  computed: {
    ...
    referenceWidgetLinkComponent() {
      return this.route ? vueRouter.RouterLink : "a";
    },
...
_l10n.register(_l10n.t37, _l10n.t42);
const _sfc_main$6 = {
...
_l10n.register(_l10n.t29, _l10n.t37, _l10n.t39);
const LIMIT = 5;
const _sfc_main$2 = {
  name: "NcSearch",
  components: {
...
const _sfc_main = {
  ...
  computed: {
    ...
    modalSize() {
      return this.isProviderSelected && Functions_registerReference.isCustomPickerElementRegistered(this.selectedProvider.id) ? Functions_registerReference.getCustomPickerElementSize(this.selectedProvider.id) ?? "large" : "normal";
    },
    showModalName() {
