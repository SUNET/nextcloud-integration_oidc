require('../assets/NcModal-ZfCDJxwd.css');
"use strict";
const ScopeComponent = require("../chunks/ScopeComponent-B5vclUCV.cjs");
...
const ChevronLeft = require("../chunks/ChevronLeft-CAiEPWc5.cjs");
const ChevronRight = require("../chunks/ChevronRight-ZCKVg9OI.cjs");
...
_l10n.register(_l10n.t17, _l10n.t33);
...
const __default__ = {
  ...
  computed: {
     ...
     */
    forceDarkBackdrop() {
      return this.canClose && !this.closeButtonContained || this.hasNext || this.hasPrevious || this.modalName !== "" || Boolean(this.$slots.actions);
    },
    /**
     * Trimmed modal name
     */
    ...
    playPauseName() {
      return this.playing ? _l10n.t("Pause slideshow") : _l10n.t("Start slideshow");
    },
    closeButtonAriaLabel() {
      return _l10n.t("Close");
    },
    prevButtonAriaLabel() {
      return _l10n.t("Previous");
    },
    nextButtonAriaLabel() {
      return _l10n.t("Next");
    }
  ...
  methods: {
    ...
    handleKeydown(event) {
      if (event.key === "Escape") {
        const trapStack = focusTrap.getTrapStack();
...
const __injectCSSVars__ = () => {
  Vue.useCssVars((_vm, _setup) => ({
    "8ad040f8": _vm.cssSlideshowDelay
  }));
};
...
var _sfc_render = function render3() {
  ...
  }, proxy: true }]) })], 1), _c("div", { staticClass: "modal-container", attrs: { "id": "modal-description-" + _vm.randId } }, [_c("div", { staticClass: "modal-container__content" }, [_vm._t("default")], 2), _vm.canClose && _vm.closeButtonContained ? _c("NcButton", { staticClass: "modal-container__close", attrs: { "type": "tertiary", "aria-label": _vm.closeButtonAriaLabel }, on: { "click": _vm.close }, scopedSlots: _vm._u([{ key: "icon", fn: function() {
    return [_c("Close", { attrs: { "size": 20 } })];
...
ScopeComponent.ScopeComponent(NcModal);
module.exports = NcModal;
