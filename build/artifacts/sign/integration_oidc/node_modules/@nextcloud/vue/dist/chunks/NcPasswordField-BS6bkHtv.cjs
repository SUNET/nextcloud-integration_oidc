require('../assets/NcPasswordField-whtKJFcB.css');
"use strict";
...
const NcInputField = require("./NcInputField-DkhKrb8k.cjs");
...
const _sfc_main = {
  ...
  computed: {
    ...
    trailingButtonLabelPassword() {
      return this.isPasswordHidden ? _l10n.t("Show password") : _l10n.t("Hide password");
    },
