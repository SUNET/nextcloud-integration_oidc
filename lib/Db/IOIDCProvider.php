 ...
 * @method setIssuer(string $issuer): void
 * @method setJwksUri(string $jwksUri): void
 ...
 * @method setTokenEndpointAuthMethod(string $tokenEndpointAuthMethod): void
 * @method setUserEndpoint(?string $userEndpoint): void
 * @method setConfigVersion(int $configVersion): void
 * @method getAccessType(): string
 * @method getDisplay(): string
 * @method getDomainHint(): string
 * @method getHd(): string
 * @method getIncludeGrantedScopes(): string
 * @method getIssuer(): string
 * @method getJwksUri(): string
 ...
 * @method getTokenEndpointAuthMethod(): string
 * @method getRevokeEndpoint(): ?string
 * @method getUserEndpoint(): ?string
 * @method getConfigVersion(): int
 *
 */
class IOIDCProvider extends Entity implements JsonSerializable
{
    ...
    public function __construct()
    {
        ...
        $this->addType('configVersion', 'integer');
    }
    /**
     * @param array $params
     * @return IOIDCProvider
     */
    public function setParams(array $params, bool $preserveSecret = false): IOIDCProvider
    {
        $this->setAccessType($params['access_type']);
        $this->setAuthEndpoint($params['auth_endpoint']);
        $this->setClientId($params['client_id']);
        if (!$preserveSecret || (isset($params['client_secret']) && $params['client_secret'] !== '')) {
        ...
        $this->setIssuer($params['issuer']);
        $this->setJwksUri($params['jwks_uri']);
        ...
        $this->setTokenEndpointAuthMethod($params['token_endpoint_auth_method']);
    ...
    public function jsonSerialize(): array
    {
        $data = array(
            ...
            'hasClientSecret' => is_string($this->getClientSecret()) && $this->getClientSecret() !== '',
